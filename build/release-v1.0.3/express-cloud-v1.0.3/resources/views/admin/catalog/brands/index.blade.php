        ...
        <div class="grid gap-6 xl:grid-cols-[1fr_380px]">
            <x-ui.card title="Brand directory">
                <div class="space-y-3">
                    ...
                    @empty
                        <p class="py-8 text-center text-sm text-slate-500">No brands configured.</p>
                    @endforelse
                </div>
            </x-ui.card>

            <x-ui.card title="Create brand">
                <form method="POST" action="{{ route('admin.catalog.brands.store') }}" class="space-y-4">
                    @csrf
