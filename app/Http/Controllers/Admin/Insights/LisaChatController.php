...
final readonly class LisaChatController
{
    ...
    public function index(Request $request): View
    {
        ...
        return view('admin.insights.chat', ['activeConversation' => null, 'conversations' => LisaConversation::query()->where('account_id', $actor->getKey())
            ...
            ->latest('last_message_at')->paginate(config('pagination.default', 10))->withQueryString()]);
    }
    ...
    {
        return view('admin.insights.audit', ['conversations' => LisaConversation::query()->with(['account', 'branch'])->withCount('messages')->latest('last_message_at')->paginate(config('pagination.default', 10))]);
    }
