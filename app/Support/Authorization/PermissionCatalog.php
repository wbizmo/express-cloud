    ...
    public static function grouped(): array
    {
        return [
            ...
            'catalog' => [
                ...
                'products.prices.adjust' => 'Bulk-adjust branch product prices',
                ...
                'warehouses.view' => 'View warehouses and warehouse balances',
                'warehouses.manage' => 'Create and manage warehouses',
                'warehouses.operate' => 'Move and condition warehouse stock',
                'inventory.reservations.manage' => 'Create and release stock reservations',
                'inventory.counts.manage' => 'Run and post warehouse stock counts',
                'procurement.requisitions.view' => 'View purchase requisitions',
                'procurement.requisitions.create' => 'Create purchase requisitions',
                'procurement.requisitions.approve' => 'Approve purchase requisitions',
                'procurement.receipts.create' => 'Record partial and complete goods receipts',
                'procurement.landed-cost.manage' => 'Allocate landed cost to inventory',
                'supplier-credits.manage' => 'Create supplier credit notes',
                ...
                'activity.export' => 'Export system activity log',
            ...
            'Commercial' => [
                ...
                'sales.edit' => 'Edit / reissue an invoice',
                'sales.void' => 'Void a sale',
                'sales.export' => 'Export sales lists (CSV/Excel/PDF)',
            ...
            'Accounting Operations' => [
                ...
                'accounting.reports.export' => 'Export financial reports (CSV/Excel/PDF)',
                'accounting.sync' => 'Synchronize operational accounting',
                'accounting.depreciation.post' => 'Post fixed-asset depreciation',
                'accounting.enterprise.view' => 'View enterprise accounting workspace',
                'accounting.close' => 'Close and lock accounting periods',
                'accounting.bank-reconcile' => 'Import and reconcile bank statements',
                'accounting.treasury.manage' => 'Manage treasury transfers',
