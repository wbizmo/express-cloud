...
<x-ui.card title="Return details"><div class="grid gap-4 md:grid-cols-2"><label><span class="mb-2 block text-sm font-medium">Refund method</span><select name="refund_method"><option value="">No refund method recorded</option><option>Cash</option><option>Bank Transfer</option><option>Store Credit</option></select></label><x-ui.input name="reason" label="Reason" required /></div></x-ui.card>
